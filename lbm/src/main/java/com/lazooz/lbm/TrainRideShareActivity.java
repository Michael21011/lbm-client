...
public class TrainRideShareActivity extends ActionBarActivity
        implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {

    private static final String TAG = "lbm TrainRideShareActivity" ;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(activity_train_rideshare);
