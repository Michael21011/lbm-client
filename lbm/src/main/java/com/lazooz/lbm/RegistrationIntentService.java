...
public class RegistrationIntentService extends IntentService {
    ...
    private void sendRegistrationToServer(String token) {
        String userid = MySharedPreferences.getInstance().getUserId(getApplicationContext());
        Log.i(TAG, "Registered userid=" + userid + " with token=" + token);
        ServerCom bServerCom = new ServerCom(getApplicationContext());
        bServerCom.subscribePushNotication(userid, token);
