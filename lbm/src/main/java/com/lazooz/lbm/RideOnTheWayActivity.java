...
public class RideOnTheWayActivity extends ActionBarActivity implements View.OnClickListener,
        GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback<People.LoadPeopleResult> {

    private static final String TAG = "RideOnTheWayActivity";
        ...
        imgProfilePic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                */
                ...
                String LoginName[] =  personName.split(" ");
                Integer OpponentId = Integer.valueOf(OponnedID);
                Intent intent = new Intent(RideOnTheWayActivity.this, SplashChatActivity.class);
                String ChatLogin = MySharedPreferences.getInstance().getUserProfile(RideOnTheWayActivity.this, "ChatLogin");
    ...
    private void SignUpUser(String name ,String Password) {
        ...
        QBUsers.signUpSignInTask(qbUser, new QBEntityCallbackImpl<QBUser>() {
            ...
            public void onError(List<String> strings) {
                ...
                Toast.makeText(RideOnTheWayActivity.this, "fail to sign to QuickBlox chat", Toast.LENGTH_LONG).show();
...
*/
    ...
    private class SubmitProfileToServer extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            ServerCom bServerCom = new ServerCom(RideOnTheWayActivity.this);
            ...
            try {
                MySharedPreferences msp = MySharedPreferences.getInstance();
                bServerCom.setUserProfile(msp.getUserId(RideOnTheWayActivity.this), msp.getUserSecret(RideOnTheWayActivity.this), personName, personPhotoUrl, personGooglePlusProfile, email, chatId);
    ...
    private class SendAcceptMatchToServer extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                MySharedPreferences msp = MySharedPreferences.getInstance();
                bServerCom.setAcceptMatchRequest(msp.getUserId(RideOnTheWayActivity.this), msp.getUserSecret(RideOnTheWayActivity.this), MatchRequestId, Accept);
                jsonReturnObj = bServerCom.getReturnObject();
            } catch (Exception e1) {
                e1.printStackTrace();
            }
